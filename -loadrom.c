...
rominfo_t game_list[] = {
    ...
    {0xA577CE46, 0, DISPLAY_PAL, TERRITORY_EXPORT, "Micro Machines"},
    {0x8813514B, 0, DISPLAY_PAL, TERRITORY_EXPORT, "Excellent Dizzy (Proto)"},
    {0xAA140C9C, 0, DISPLAY_PAL, TERRITORY_EXPORT, "Excellent Dizzy (Proto - GG)"}, 
    {0x1b10a951, MAPPER_CODIES, DISPLAY_PAL, TERRITORY_EXPORT, "Bram Stoker's Dracula"},
    {0xc8718d40, MAPPER_CODIES, DISPLAY_PAL, TERRITORY_EXPORT, "Aladdin"}, 
    {-1        , -1  , -1, -1, NULL},
};
